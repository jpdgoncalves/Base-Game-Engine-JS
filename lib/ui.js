...
MH.scope(() => {
    ...
    class UIElement extends EventEmitter {
         ...
         */
        update(deltatime) {
            console.warn("This update method has not been overriden");
        }
         ...
         */
        draw(context) {
            console.warn("This draw method has not been overriden");
        }
...
MH.scope(() => {
    ...
    const ui = MH.module("engine.ui");
    
    const {UIElement} = ui;

    class TextInput extends UIElement {
        constructor(id, top = 0, left = 0, width = 0, height = 0) {
            super(id, top = 0, left = 0, width = 0, height = 0);
        ...
        emit(event, data) {
            if(event === "keydown") {
                console.log(`Received key input '${data}'`);
            }
