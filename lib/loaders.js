MH.scope(() => {
    ...
    const loaders = MH.create("engine.loaders");

    loaders.loadImage = function(src) {
        return new Promise(
            (resolve) => {
    ...
    loaders.loadAudio = function(src) {
        return new Promise(
            (resolve) => {
    ...
    loaders.loadJSONP = function(src) {
        return new Promise(
            (resolve) => {
    ...
    loaders.loadBufferMaker = async function(src) {
    ...
    loaders.loadInParalel = function(...promises) {
