...
engine.core.scope(function() {
    ...
    core.ProtectedObject = class {

        constructor(child) {
            this.readOnlyInstance = new Proxy(child, {
                set: function(obj, key, value) {
                    throw new Error("[ProtectedObject] you cannot change the properties of this object");
                }
            });
        }
